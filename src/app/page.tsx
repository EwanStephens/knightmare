    ...
    <main>
      ...
      {showTutorialPrompt ? (
        <div className="flex flex-col gap-4 items-center">
          ...
          <button
            className="px-6 py-3 bg-[#4059AD] text-white rounded-lg text-xl font-semibold hover:bg-[#2D4185] transition-colors duration-200 w-64"
            onClick={handleStartTutorial}
          >
            Start Tutorial
          </button>
          <button
            className="px-6 py-3 bg-[#769656] text-white rounded-lg text-xl font-semibold hover:bg-[#5a7042] transition-colors duration-200 w-64"
