...
export default function CompletionModal({
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-[#3A3B3A] rounded-lg shadow-lg dark:shadow-gray-700 p-8 flex flex-col items-center gap-6 min-w-[320px] transition-colors duration-200 relative border dark:border-gray-600">
        {/* X button */}
        <button
          onClick={onClose}
