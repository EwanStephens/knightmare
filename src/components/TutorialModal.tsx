...
export default function TutorialModal() {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-50 flex justify-center ${isModalOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'} transition-opacity duration-300`}>
      {/* No full-screen overlay - this allows visibility of the board */}
      <div className="bg-white rounded-t-lg p-4 max-w-md w-full mx-4 z-10 shadow-xl mb-0 border-t border-gray-200 bg-opacity-90">
